...
import com.incomrecycle.prms.rvm.gui.activity.starput.QRCodeResultActivity;
import java.util.HashMap;

import static android.content.Intent.FLAG_ACTIVITY_REORDER_TO_FRONT;

public class GUIActionGotoServiceProcess3QRCode extends GUIAction {
    ...
    protected void doAction(Object[] paramObjs) {
        ...
        try {
            this.hsmpStatus = this.guiCommonService.execute("GUIQRCodeCommonService", "recycleEnd", null);
            Intent intent = new Intent(baseActivity, QRCodeResultActivity.class);
