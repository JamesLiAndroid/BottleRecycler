...
import com.incomrecycle.prms.rvm.gui.activity.starput.PhoneRechargeResultActivity;
import java.util.HashMap;

import static android.content.Intent.FLAG_ACTIVITY_REORDER_TO_FRONT;

public class GUIActionGotoServiceProcess3Phone extends GUIAction {
    ...
    protected void doAction(Object[] paramObjs) {
        ...
        try {
            this.hsmpStatus = this.guiCommonService.execute("GUIPhoneCommonService", "recycleEnd", null);
            Intent intent = new Intent(baseActivity, PhoneRechargeResultActivity.class);
