...
import com.incomrecycle.prms.rvm.gui.activity.starput.AlipayResultActivity;
import java.util.HashMap;

import static android.content.Intent.FLAG_ACTIVITY_REORDER_TO_FRONT;

public class GUIActionGotoServiceProcess3Alipay extends GUIAction {
    ...
    protected void doAction(Object[] paramObjs) {
        ...
        try {
            ...
            Intent intent = new Intent(baseActivity, AlipayResultActivity.class);
