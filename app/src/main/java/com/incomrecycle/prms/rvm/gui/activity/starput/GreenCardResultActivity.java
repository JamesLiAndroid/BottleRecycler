...
public class GreenCardResultActivity extends BaseActivity {
    private String JSON;
            ...
            GUIAction guiAction = new GUIAction() {
                protected void doAction(Object[] paramObjs) {
                    ...
                    if (remainedSeconds == 0) {
                        ...
                        if (!StringUtils.isBlank(GreenCardResultActivity.this.JSON) && "BOTTLE".equalsIgnoreCase(ServiceGlobal.getCurrentSession("PRODUCT_TYPE").toString())) {
                            intent.setClass(GreenCardResultActivity.this, EnvironmentalPromotionalActivity.class);
                            intent.putExtra("JSON", GreenCardResultActivity.this.JSON);
                        } else if (!StringUtils.isBlank(SysConfig.get("RVMMActivity.class"))) {
                            try {
                                intent.setClass(GreenCardResultActivity.this.getBaseContext(), Class.forName(SysConfig.get("RVMMActivity.class")));
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                        intent.setFlags(FLAG_ACTIVITY_REORDER_TO_FRONT);
                        GreenCardResultActivity.this.startActivity(intent);
                        GreenCardResultActivity.this.finish();
                        return;
                    }
                    ((TextView) GreenCardResultActivity.this.findViewById(R.id.green_card_result_time)).setText("" + remainedSeconds);
                }
            };
            GreenCardResultActivity.this.executeGUIAction(false, guiAction, new Object[]{Integer.valueOf(forwardSeconds), Integer.valueOf(remainedSeconds)});
        }
    };
    ...
    public void onStart() {
        ...
        try {
            ...
            HashMap hsmpStatus = JSONUtils.toHashMap(this.JSON);
            if (hsmpStatus != null) {
    ...
    protected void onStop() {
        super.onStop();
        findViewById(R.id.green_card_result_layout).setBackgroundDrawable(null);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_card_result);
        backgroundToActivity();
        ((Button) findViewById(R.id.green_card_result_end)).setOnClickListener(new OnClickListener() {
