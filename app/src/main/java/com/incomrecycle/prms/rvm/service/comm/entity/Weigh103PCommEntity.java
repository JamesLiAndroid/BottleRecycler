...
public class Weigh103PCommEntity implements CommEntity {
    ...
    private class RecvThread extends Thread {
        ...
        public void run() {
            DataInputStream is = new DataInputStream(Weigh103PCommEntity.this.weighSerialPort.getInputStream());
            ...
            try {
                ...
                while (true) {
                    ...
                    synchronized (Weigh103PCommEntity.this.baos) {
                        Weigh103PCommEntity.this.baos.write(data, 0, readLen);
                    }
                }
            } catch (Exception e) {
            } finally {
                Weigh103PCommEntity.this.weighSerialPort.close();
                Weigh103PCommEntity.this.weighSerialPort = null;
            }
        }
    }
