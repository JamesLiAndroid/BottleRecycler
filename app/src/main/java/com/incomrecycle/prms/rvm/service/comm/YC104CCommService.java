...
import com.incomrecycle.prms.rvm.service.comm.entity.PLC104CCommEntity;
...
import com.incomrecycle.prms.rvm.service.comm.executor.YC104CCheckCommCmdExecutor;

import java.util.ArrayList;
import java.util.List;

public class YC104CCommService extends AbstractCommService {
    public YC104CCommService() {
        ...
        if (list.contains("PLC")) {
            setCommonEntity("PLC", new PLC104CCommEntity());
        }
...
//        }
        ...
        addCommonCmdExecutor(new YC104CCheckCommCmdExecutor());
    }
}
