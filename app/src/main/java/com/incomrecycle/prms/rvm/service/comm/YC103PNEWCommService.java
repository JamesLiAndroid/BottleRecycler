...
import com.incomrecycle.prms.rvm.service.comm.entity.DigitalScreenDC80480S050_01TWCommEntity;
...
public class YC103PNEWCommService extends AbstractCommService {
    public YC103PNEWCommService() {
        ...
        if (list.contains("DigitalScreen")) {
            setCommonEntity("DigitalScreen", new DigitalScreenDC80480S050_01TWCommEntity());
        }
