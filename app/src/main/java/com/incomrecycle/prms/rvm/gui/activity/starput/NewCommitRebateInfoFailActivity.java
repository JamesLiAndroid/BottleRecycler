...
public class NewCommitRebateInfoFailActivity extends BaseActivity {
    ...
    private TimeoutAction timeoutAction = new TimeoutAction() {
        public void apply(int forwardSeconds, int remainedSeconds) {
            GUIAction guiAction = new GUIAction() {
                protected void doAction(Object[] paramObjs) {
                    ...
                    if (remainedSeconds != 0) {
                        ((TextView) NewCommitRebateInfoFailActivity.this.findViewById(R.id.onecard_rebate_commit_fail_time)).setText("" + remainedSeconds);
                    } else if (!StringUtils.isBlank(SysConfig.get("RVMMActivity.class"))) {
                        try {
                            Intent intent = new Intent(NewCommitRebateInfoFailActivity.this.getBaseContext(), Class.forName(SysConfig.get("RVMMActivity.class")));
                            intent.setFlags(FLAG_ACTIVITY_REORDER_TO_FRONT);
                            NewCommitRebateInfoFailActivity.this.startActivity(intent);
                            NewCommitRebateInfoFailActivity.this.finish();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
            ...
            NewCommitRebateInfoFailActivity.this.executeGUIAction(false, guiAction, new Object[]{Integer.valueOf(forwardSeconds), Integer.valueOf(remainedSeconds)});
        }
    };
        ...
        if (this.isPlaySounds && this.soundPool != null) {
            ...
            this.soundPool.setOnLoadCompleteListener(new OnLoadCompleteListener() {
                public void onLoadComplete(SoundPool soundPool, int sampleId, int status) {
                    if (sampleId == NewCommitRebateInfoFailActivity.this.chongZhiShiBai) {
    ...
    public void onStop() {
        ...
        ((TextView) findViewById(R.id.onecard_rebate_commit_fail_time)).setText("");
