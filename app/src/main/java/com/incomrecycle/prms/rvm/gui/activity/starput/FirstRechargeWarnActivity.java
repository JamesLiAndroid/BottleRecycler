...
public class FirstRechargeWarnActivity extends BaseActivity {
    private String JSON;
            ...
            GUIAction guiAction = new GUIAction() {
                protected void doAction(Object[] paramObjs) {
                    ...
                    if (remainedSeconds == 0) {
                        ...
                        intent.setClass(FirstRechargeWarnActivity.this, EnvironmentalPromotionalActivity.class);
                        intent.putExtra("JSON", FirstRechargeWarnActivity.this.JSON);
                        intent.setFlags(FLAG_ACTIVITY_REORDER_TO_FRONT);
                        FirstRechargeWarnActivity.this.startActivity(intent);
                        FirstRechargeWarnActivity.this.finish();
                        return;
                    }
                    ((TextView) FirstRechargeWarnActivity.this.findViewById(R.id.onecard_firt_recharge_time)).setText("" + remainedSeconds);
                }
            };
            FirstRechargeWarnActivity.this.executeGUIAction(false, guiAction, new Object[]{Integer.valueOf(forwardSeconds), Integer.valueOf(remainedSeconds)});
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onecardfirstrecharge_info);
        backgroundToActivity();
        ((Button) findViewById(R.id.onecard_firt_recharge_bangding)).setOnClickListener(new OnClickListener() {
            public void onClick(View arg0) {
                Intent intent = new Intent(FirstRechargeWarnActivity.this, BindCardActivity.class);
                intent.putExtra("JSON", FirstRechargeWarnActivity.this.JSON);
                intent.setFlags(FLAG_ACTIVITY_REORDER_TO_FRONT);
                FirstRechargeWarnActivity.this.startActivity(intent);
                FirstRechargeWarnActivity.this.finish();
        ...
        if (isPlaySounds && this.soundPool != null) {
            ...
            this.soundPool.setOnLoadCompleteListener(new OnLoadCompleteListener() {
                public void onLoadComplete(SoundPool soundPool, int sampleId, int status) {
                    if (sampleId == FirstRechargeWarnActivity.this.kaWeiBangDing) {
