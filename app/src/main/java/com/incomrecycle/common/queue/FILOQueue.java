...
public class FILOQueue extends AbstractQueue {
    ...
    public void push(Object obj) {
        ...
        synchronized (this) {
            tQueueElement.m_next = this.m_root;
    ...
    public void reset() {
        synchronized (this) {
            while (this.m_root != null) {
                QueueElement tQueueElement = this.m_root;
                this.m_root = this.m_root.m_next;
    ...
    L_0x003b:
        ...
        r7 = r7.m_next;	 Catch:{ all -> 0x0038 }
        r12.m_root = r7;	 Catch:{ all -> 0x0038 }
        r5 = r6.m_obj;	 Catch:{ all -> 0x0038 }
        r7 = 0;
    ...
    L_0x0054:
        ...
        goto L_0x0016;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.incomrecycle.common.queue.FILOQueue.pop(long):java.lang.Object");
    }
